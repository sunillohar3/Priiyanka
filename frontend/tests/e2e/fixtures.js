...
const SERVICES = [
  { service_id: 'svc-consult', name_en: 'Ayurvedic Consultation', name_nl: 'Ayurvedisch Consult',
    ...
    price: 65, duration: 60, category: 'Consultation', image_url: '', display_order: 1 },
...
const ADMIN_USERS = [ { user_id: 'u-admin', email: 'admin@example.com', name: 'Admin User', role: 'admin' },
                      { user_id: 'u-1', email: 'client@example.com', name: 'Client One', role: 'client' } ];
const ADMIN_MESSAGES = [ { message_id: 'm-1', name: 'Jane', email: 'jane@example.com', subject: 'Hi', message: 'Question', status: 'new' } ];
const BLOCKED_SLOTS = [];
